...
const roledets = require('../models/roledet.model'); //calling the users schema 
const { stringify } = require('querystring');

//https://www.youtube.com/watch?v=NPyFYsZb2gE&list=PLIjdNHWULhPSZFDzQU6AnbVQNNo1NTRpd&index=11
//Identify exactly what I got from the videos, online websites and also github repositories
...
let generateRefreshTokenExpiryTime = () => {
   // let daysUntilExpire = "10";
    let secondsUntilExpire = 15;//((daysUntilExpire * 24) * 60) * 60;
